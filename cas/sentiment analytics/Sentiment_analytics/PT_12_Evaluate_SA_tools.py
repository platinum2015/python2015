...
def main():    
    ...
    for tool in tools:
        ...
        print tool,' semEvalMakroF1:',semEvalMakroF1
        raw_input(">")
    ...
    for collection in corpus:
        ...
        for tool in tools:    
            ...
            #print tool,' collection:',collection,' F1: ' + str(semEvalMakroF1)
            #collection_results_all[collection].append(str('%.3f' % semEvalMakroF1) )
            #tool_results_all[tool] = tool_results[tool] +  semEvalMakroF1     
